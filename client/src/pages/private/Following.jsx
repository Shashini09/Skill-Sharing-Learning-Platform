...
const Profile = () => {
  ...
  const handleUnfollow = async (userId) => {
    try {
      await axios.delete(`http://localhost:8080/users/${userId}/unfollow`, {
        withCredentials: true,
        headers: { 'Content-Type': 'application/json' },
      });
      // Fetch updated following list
                    ...
                    <div className="flex items-center justify-between p-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="text-red-600 hover:text-red-700 px-3 py-1 rounded-md border border-red-200 hover:border-red-300 bg-white hover:bg-red-50 transition duration-150 text-sm"
                        >
                          Unfollow
                        </button>
                        <Link
