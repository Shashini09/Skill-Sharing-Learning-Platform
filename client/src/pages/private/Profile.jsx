      ...
      >
        <div className="flex flex-col h-full">
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-4 flex justify-between items-center">
            <div>
              <h1 className="text-lg font-bold text-white">CookBook Community Chat</h1>
              <div className="flex items-center mt-1">
                <span className={`h-2 w-2 rounded-full ${
                  connectionStatus === 'connected' ? 'bg-purple-300' : 
                      ...
                      >
                        {!isFromCurrentUser && (
                          <div className="h-8 w-8 rounded-full bg-purple-100 flex items-center justify-center mr-2 flex-shrink-0">
                            <span className="text-purple-700 font-medium text-sm">{getInitial(msg.senderName)}</span>
                          </div>
                        )}
